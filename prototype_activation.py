...
# Select model to use
load_model_dir = './saved_models/vgg19/003_cub/'  # Model directory to ProtoPNet. 
load_model_name = '999nopush0.7408.pth'# Model name of trained ProtoPNet
...
prototypes = range(60) #range(2000)

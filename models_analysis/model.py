...
class PPNet(nn.Module):
    ...
    def prototype_distances(self, x):
        ...
        #global_vars.imgs_fts = conv_features          
    ...
    def distance_2_similarity(self, distances):
        if self.prototype_activation_function == 'log':
            ...
            # torch.log(10,000) = 9,2103
            # torch.log(1,000) = 6,9077
            # torch.log(100) = 4,60517
            # torch.log(10) = 2,302585
    ...
    def forward(self, x):
        ...
        #global_vars.imgs_fts = conv_features          
        #distances = self._l2_convolution(conv_features)
        distances, conv_features = self.prototype_distances(x)
        '''
        ...
        return logits, min_distances, conv_features

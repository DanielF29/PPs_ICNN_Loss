...
if __name__ == '__main__':
    ...
    parser.add_argument('-dataset', type=str, default='./datasets/Mix/') # -dataset=./datasets/Mix/
    # , choices=["./datasets/Mix/", "./datasets/Sec/", "./datasets/Sur/"]
    ...
    model_dir = './saved_models/'+ run + '/' + dataset_name + '_' + Data_augmentation_mode  + '_' +  base_architecture +  '_' + str(pps_per_class) + 'pps/'
    makedir(model_dir)

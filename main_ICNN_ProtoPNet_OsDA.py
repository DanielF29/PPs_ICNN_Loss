...
if __name__ == '__main__':
    ...
    parser.add_argument('-dataset', type=str, default='./datasets/Mix/', choices=["./datasets/Mix/", "./datasets/Sec/", "./datasets/Sur/"]) # -dataset=./datasets/Mix/
    ...
    # python3 mainSection.py -gpuid=$1 -base_architecture=resnet50 -pps_per_class=10 -num_classes=6 -experiment_num=001
    ...
    model_dir = './saved_models/'+ run + '/' + dataset_name + '_' + Data_augmentation_mode  + '_' +  base_architecture +  '_' + str(pps_per_class) + '/'
    makedir(model_dir)
    ...
    # load the data
    #from settings_icnn import train_dir, test_dir, train_push_dir, \
    ...
    from settings_icnn import num_train_epochs, num_warm_epochs, push_start, push_epochs

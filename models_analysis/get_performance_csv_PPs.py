...
parser.add_argument('-modeldir', nargs=1, type=str) # -modeldir=
parser.add_argument('-model', nargs=1, type=str) #-model=
...
save_analysis_path = os.path.join('pps_icnn_results_'+ test_dir_name, model_base_architecture[0]) # os.path.join('pps_explanations', model_base_architecture, experiment_run, load_model_name)
...
path_to_csv_file = os.path.join(save_analysis_path, csv_file_name) # generates the path and name for the "csv" file

...
def update_prototypes_on_batch(search_batch_input,
    ...
    if preprocess_input_function is not None:
        ...
        #print("1 -- search_batch.size(): ", search_batch_input.size(), \
        #      " Max: ", torch.max(search_batch_input).item(), " Min: ", torch.min(search_batch_input).item() ) 
        search_batch = preprocess_input_function(search_batch_input)
        #print("2 -- search_batch.size(): ", search_batch.size(), \
        #      " Max: ", torch.max(search_batch).item(), " Min: ", torch.min(search_batch).item() ) 
